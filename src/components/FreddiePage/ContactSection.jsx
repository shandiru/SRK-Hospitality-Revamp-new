          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  <span style={{ color: BRAND_GOLD, fontWeight: 600 }}>Pickup</span>
                  <br />
                  ...
                  <br />
                  Wed: <span style={{ color: '#EF4444', fontWeight: 600 }}>Closed</span>
                  <br /><br />
                  <span style={{ color: BRAND_GOLD, fontWeight: 600 }}>Delivery</span>
                  <br />
                  Mon, Tue, Thu: 5:30 PM – 10:50 PM
                  <br />
                  Fri, Sat: 5:30 PM – 1:00 AM
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  <a
                    href="https://maps.app.goo.gl/isQCwC2UdfVUww9UA"
                    target="_blank"
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p>
                  <a href="tel:01158714164" className="hover:text-[#E1B43B]" >
                    0115 871 4164
                  </a>
                </p>
              </div>
            ...
            {/* Website */}
            <a
              href="https://freddiesdessertsonline.com/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <div className="flex gap-4 pt-4">
              <a
                href="https://www.instagram.com/freddiesdesserts/?hl=en"
                target="_blank"
                rel="noopener noreferrer"
