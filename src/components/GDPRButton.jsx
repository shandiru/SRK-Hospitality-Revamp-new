      ...
      {visible && (
        <div className="fixed bottom-4 left-4 right-4 md:bottom-6 text-center md:right-6 md:left-auto max-w-full md:max-w-xs p-4 rounded-lg 
          ...
          <p className="mb-3">
            <a
              href="/privacy"
              className="underline text-[#DDB64E] hover:text-[#e2b740] dark:text-[#DDB64E] dark:hover:text-[#e2b740]"
            >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            <button
              ...
              className="bg-[#DDB64E] text-white px-4 py-2 rounded text-sm hover:bg-[#e2b740] dark:hover:bg-[#e2b740] transition"
            >
              Reject
            </button>
            <button
      ...
      {showIcon && !visible && (
        <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-40">
          <button
            ...
            className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#DDB64E] shadow-lg border border-white 
