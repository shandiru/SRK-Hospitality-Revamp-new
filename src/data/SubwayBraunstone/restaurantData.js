...
export const SubwayBraunstone = {
    // Welcome Section Data
    welcome: {
        title: "Welcome To Subway Braunstone Gate",
        subtitle: "Multinational fast food restaurant on Braunstone Gate, Leicester",
    ...
    about: {
        ...
        subtitle: null,
        image: "/subway2.avif",
        imageCaption: "The Subway Braunstone Gate",
        content: [
            "At your local Subway®, Unit 5, Braunstone Gate, when we say you can Make It What You Want ®, we really mean it. Create your own sub, salad or wrap and fill it with everything that you love.",
            ...
            "All Subway® stores are independently owned with talented Sandwich Artists™ ready to take your order in-store, for collection via our Subcard® app, or delivered straight to your home via our friends over at Just Eat, Uber Eats or Deliveroo. So go meaty, go plant-based, go spicy, go saucy, or just go ALL OUT."
        ]
        ,
        brandColor: "#DDB64E"
    },
    ...
    // Menu Flipbook Data
    menu: {
        restaurantName: "Subway Braunstone Gate",
        tagline: "Multinational fast food restaurant on  Braunstone Gate",
    ...
    // Gallery Data
    gallery: {
        title: "Subway Braunstone Gate Gallery",
        images: [
            "subway5.png",
            "subway4.png",
            "subway6.png",
